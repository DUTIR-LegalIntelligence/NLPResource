...
class Data:
    ...
    def batch_iter(self, name, batch_size, shuffle=True, volatile_flag=False):
        ...
        for batch_id in range(total_batch):
            ...
            batch_label_tensor = autograd.Variable(torch.zeros(ins_num),volatile =  volatile_flag).long()
            ...
            #print(text[0][0][4],text[0][0][5])
            yield (gaz_list, word_seq_tensor, biword_seq_tensor, word_seq_lengths, char_seq_tensor, char_seq_lengths, char_seq_recover, pos1_seq_tensor, pos2_seq_tensor, ins_label_tensor, batch_label_tensor, mask, scope,text[0][0][4],text[0][0][5])
